...
public final class PropertiesLoader {
     ...
     * 微信公众号appId
     **/
    static final String APP_ID = getInterfaceProperties().getProperty("appId");
    /**
     * 微信公众号appSecret
     **/
    static final String APP_SECRET = getInterfaceProperties().getProperty("appSecret");
    /**
     * 验证代理服务器是否可用的token,在微信开发者中心配置,为开发者随意填写
     **/
    static final String TOKEN = getInterfaceProperties().getProperty("token");
    /**
     * 获取微信access_token的地址
     **/
